...
def myfunc():
  ...
  SO_c_d_t = {"userId":"category","movieId":"int64","rating":"float32","timestamp":"int64"}
  ratings_df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b2/s1.csv',low_memory=False,dtype=SO_c_d_t)
  metas_df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b2/movies_metadata.csv',low_memory=False,dtype={'budget':'object','id':'object','popularity':'object','revenue':'float64','vote_count':'float64'})
  SO_c_d_t = {"movieId":"int64","imdbId":"int64","float32":"int64"}
  links_df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b2/links.csv',low_memory=False,dtype=SO_c_d_t)
...
if (__name__ == '__main__'):
   ...
   writer.writerow(['b8','150MB','s1.csv','ldask',time2,format(ram_usage),816])
   file.close()
pd.flush()
