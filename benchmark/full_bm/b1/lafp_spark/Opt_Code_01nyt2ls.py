...
def myfunc():
  ...
  df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b1/s2.csv',usecols=SO_columns,parse_dates=SO_d_d_t,dtype=SO_c_d_t)
...
if (__name__ == '__main__'):
   ...
   writer.writerow(['b1','450MB','s2.csv','lspark',time2,format(ram_usage),128])
   file.close()
pd.flush()
