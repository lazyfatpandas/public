...
def myfunc():
    ...
    df = con.read_csv("/media/bhushan/nvme1/data/vldb/b31/s1.csv")
    ...
    print(df.select(df.department).distinct())
...
=======
    ...
    # Proportion of "Left"
    # print(df.status.mean().execute())
>>>>>>> 163b7755f21108633c18b21b0fc81eb729911096
...
if __name__=='__main__':
    ...
    writer.writerow(["b31", "150MB", "s1.csv","ibis",time2,format(ram_usage),3119])
    file.close()
