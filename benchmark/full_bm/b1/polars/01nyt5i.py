...
def myfunc():
    ...
    t = con.read_csv('/media/bhushan/nvme1/data/vldb/b1/s5.csv')
    ...
    # )
    time_cast = t.tpep_pickup_datetime

    if (not(isinstance(time_cast, ibis.expr.types.TimestampColumn))):
        time_cast = time_cast.cast("timestamp")

    t = t.mutate(day=time_cast.day_of_week.index())
...
if __name__=='__main__':
    ...
    writer.writerow(["b1", "12.6GB", "s5.csv","polars",time2,format(ram_usage),"15B"])
    file.close()
