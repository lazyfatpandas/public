...
def myfunc():
    ...
    # LAFP: print added, dask unable to handle normalize=True here, works fine in line 170 and 179
...
if __name__=='__main__':
    ...
    writer.writerow(['b16','450MB','s2.csv','lpandas',time2,format(ram_usage),1622])
    file.close()
