...
def myfunc():
    ...
    start = time()
    df = con.read_csv('/media/bhushan/nvme1/data/vldb/b21/s4_city.csv',dtypes={"NUMBER": pl.Utf8})
    # head
    ...
    df2 = con.read_csv('/media/bhushan/nvme1/data/vldb/b21/s4_pluto.csv')
...
if __name__=='__main__':
    ...
    writer.writerow(["b21", "4.2GB", "s4.csv","polars",time2,format(ram_usage),"214B"])
    file.close()
