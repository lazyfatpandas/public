...
def myfunc():
    ...
    start = time()
    df = con.read_csv('/media/bhushan/nvme1/data/vldb/b21/s1_city.csv')
    # head
    ...
    df2 = con.read_csv('/media/bhushan/nvme1/data/vldb/b21/s1_pluto.csv')
...
if __name__=='__main__':
    ...
    writer.writerow(["b21", "150MB", "s1.csv","ibis",time2,format(ram_usage),2119])
    file.close()
