...
def myfunc():
  ...
  df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b3/s5.csv',usecols=SO_columns,dtype=SO_c_d_t)
...
if (__name__ == '__main__'):
   ...
   writer.writerow(['b6','12.6GB','s5.csv','lpolars',time2,format(ram_usage),'65C'])
   file.close()
