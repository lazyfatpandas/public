...
def myfunc():
  ...
  df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b1/s4.csv',usecols=SO_columns,dtype=SO_c_d_t,parse_dates=SO_d_d_t)
...
if (__name__ == '__main__'):
   ...
   writer.writerow(['b1','4.2GB','s4.csv','lpolars',time2,format(ram_usage),'14C'])
   file.close()
pd.flush()
