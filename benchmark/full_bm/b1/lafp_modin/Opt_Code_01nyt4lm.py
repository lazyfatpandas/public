...
def myfunc():
  ...
  df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b1/s4.csv',parse_dates=['tpep_pickup_datetime'],usecols=SO_columns)
...
if (__name__ == '__main__'):
   ...
   writer.writerow(['b1','4.2GB','s4.csv','lmodin',time2,format(ram_usage),144])
   file.close()
