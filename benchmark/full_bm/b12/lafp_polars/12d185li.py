...
def myfunc():
    ...
    import string
    # # Visualisations
    # df = pd.read_csv('/home/utkarsh/Downloads/data (1)/vldb/b12/s5.csv')
    df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b12/s5.csv')
    print(df.head())
...
if __name__=='__main__':
    ...
    writer.writerow(['b12','12.6GB','s5.csv','lpolars',time2,format(ram_usage),'125C'])
    file.close()
