...
def myfunc():
    ...
    t = con.read_csv("/home/utkarsh/Downloads/data (1)/vldb/b16/s1.csv", separator=";")
    ...
    #print(t[t['loan_status'] == 'yes']['education'].value_counts() / )
...
if __name__=='__main__':
    ...
    writer.writerow(["b16", "150MB", "s1.csv","polars",time2,format(ram_usage),"161B"])
    file.close()