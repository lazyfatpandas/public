...
def myfunc():
    ...
    df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b1/s5.csv',usecols=SO_columns,parse_dates=SO_d_d_t)
...
if (__name__ == '__main__'):
    ...
    writer.writerow(['b1','12.6GB','s5.csv','lpandas',time2,format(ram_usage),152])
    file.close()
