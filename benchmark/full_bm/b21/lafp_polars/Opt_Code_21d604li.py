...
def myfunc():
  ...
  df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b21/s4_city.csv',dtype=SO_c_d_t)
  print(df.head())
  ...
  df2 = pd.read_csv('/media/bhushan/nvme1/data/vldb/b21/s4_pluto.csv',dtype=SO_c_d_t)
  print(df2.head(1))
  pd.flush()
  print((time() - start))
...
if (__name__ == '__main__'):
   ...
   writer.writerow(['b21','4.2GB','s4.csv','lpolars',time2,format(ram_usage),'214C'])
   file.close()
pd.flush()
