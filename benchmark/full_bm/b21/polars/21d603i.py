...
def myfunc():
    ...
    start = time()
    df = con.read_csv('/media/bhushan/nvme1/data/vldb/b21/s3_city.csv',dtypes={"NUMBER": pl.Utf8})
    # head
    ...
    df2 = con.read_csv('/media/bhushan/nvme1/data/vldb/b21/s3_pluto.csv')
...
if __name__=='__main__':
    ...
    writer.writerow(["b21", "1.4GB", "s3.csv","polars",time2,format(ram_usage),"213B"])
    file.close()
