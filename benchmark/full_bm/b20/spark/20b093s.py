...
def myfunc():
    start = time()
    train_df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b20/s3_train.csv',dtype={"text_id":"string","full_text":"string", \
                                                                                   "cohesion":       "Float64", \
                                                                                   "syntax":         "Float64", \
                                                                                   "vocabulary":     "Float64", \
                                                                                   "phraseology":    "Float64", \
...
if __name__=='__main__':
    ...
    writer.writerow(["b20", "1.4GB", "s3.csv","spark",time2,format(ram_usage),2037])
    file.close()
