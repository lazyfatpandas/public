...
def myfunc():
    ...
    df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b21/s2_city.csv',dtype=SO_c_d_t)
    print(df.head())
    ...
    df2 = pd.read_csv('/media/bhushan/nvme1/data/vldb/b21/s2_pluto.csv',dtype=SO_c_d_t)
    print(df2.head(1))
