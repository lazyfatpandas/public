...
def myfunc():
    ...
    train_df = con.read_csv("/media/bhushan/nvme1/data/vldb/b20/s3_train.csv")
    print(train_df.schema())
    test_df = con.read_csv("/media/bhushan/nvme1/data/vldb/b20/s3_test.csv")
...
if __name__=='__main__':
    ...
    writer.writerow(["b20", "1.4GB", "s3.csv","polars",time2,format(ram_usage),"203B"])
    file.close()
