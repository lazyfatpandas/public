...
def myfunc():
  ...
  ratings_df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b2/s5.csv',low_memory=False,dtype=SO_c_d_t)
...
if (__name__ == '__main__'):
   ...
   writer.writerow(['b8','12.6GB','s5.csv','lpolars',time2,format(ram_usage),'85C'])
   file.close()
pd.flush()
