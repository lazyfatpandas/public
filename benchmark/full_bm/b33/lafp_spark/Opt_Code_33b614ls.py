...
def myfunc():
    ...
    df_riders_data_to_load = pd.read_csv('/media/bhushan/nvme1/data/vldb/b33/s4_ride.csv',dtype=SO_c_d_t)
...
if (__name__ == '__main__'):
    ...
    writer.writerow(['b33','4.2GB','s4.csv','lspark',time2,format(ram_usage),3348])
    file.close()
pd.flush()
