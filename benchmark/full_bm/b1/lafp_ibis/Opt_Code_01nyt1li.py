...
def myfunc():
  ...
  df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b1/s1.csv',parse_dates=['tpep_pickup_datetime'],usecols=SO_columns)
...
if (__name__ == '__main__'):
   ...
   writer.writerow(['b1','150MB','s1.csv','libis',time2,format(ram_usage),'11A'])
   file.close()
pd.flush()
