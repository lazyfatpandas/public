...
def myfunc():
  ...
  df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b1/s5.csv',parse_dates=['tpep_pickup_datetime'],usecols=SO_columns)
...
if (__name__ == '__main__'):
   ...
   writer.writerow(['b1','12.6GB','s5.csv','lmodin',time2,format(ram_usage),154])
   file.close()
