...
def myfunc():
  ...
  df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b3/s1.csv',usecols=SO_columns,dtype=SO_c_d_t)
...
if (__name__ == '__main__'):
   ...
   writer.writerow(['b6','150MB','s1.csv','lpandas',time2,format(ram_usage),612])
   file.close()
