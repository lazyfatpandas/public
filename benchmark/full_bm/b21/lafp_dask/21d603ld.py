...
def myfunc():
    start = time()
    print=pd.lazyPrint
    df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b21/s3_city.csv', dtype={'NUMBER': 'object', 'UNIT': 'object'})  # NOTE: dtype
    print(df.head())
...
if __name__=='__main__':
    ...
    writer.writerow(["b21", "1.4GB", "s3.csv","ldask",time2,format(ram_usage),2136])
    file.close()
