...
def myfunc():
    ...
    df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b31/s5.csv')
    ...
    # Bhushan to resolve dask error--->> TypeError: Data source must be a DataFrame or Mapping, not <class 'dask.dataframe.core.DataFrame'>. and
...
if __name__=='__main__':
    ...
    writer.writerow(["b31", "12.6GB", "s5.csv","dask",time2,format(ram_usage),3155])
    file.close()
