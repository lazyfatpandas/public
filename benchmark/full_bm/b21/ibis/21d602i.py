...
def myfunc():
    ...
    start = time()
    df = con.read_csv('/media/bhushan/nvme1/data/vldb/b21/s2_city.csv')
    # head
    ...
    df2 = con.read_csv('/media/bhushan/nvme1/data/vldb/b21/s2_pluto.csv')
...
if __name__=='__main__':
    ...
    writer.writerow(["b21", "450MB", "s2.csv","ibis",time2,format(ram_usage),2129])
    file.close()
