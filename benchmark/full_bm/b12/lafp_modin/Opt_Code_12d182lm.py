...
def myfunc():
    ...
    df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b12/s2.csv',usecols=SO_columns,dtype=SO_c_d_t)
    print(df.head())
...
if (__name__ == '__main__'):
   ...
   writer.writerow(['b12','450MB','s2.csv','lmodin',time2,format(ram_usage),1224])
   file.close()
