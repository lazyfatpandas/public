...
def myfunc():
    start = time()
    train_df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b20/s1_train.csv',dtype={"text_id":"string","full_text":"string", \
                                                                                   "cohesion":       "Float64", \
                                                                                   "syntax":         "Float64", \
                                                                                   "vocabulary":     "Float64", \
                                                                                   "phraseology":    "Float64", \
...
if __name__=='__main__':
    ...
    writer.writerow(["b20", "150MB", "s1.csv","spark",time2,format(ram_usage),2017])
    file.close()
