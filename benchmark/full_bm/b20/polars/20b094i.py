...
def myfunc():
    ...
    train_df = con.read_csv("/media/bhushan/nvme1/data/vldb/b20/s4_train.csv")
    print(train_df.schema())
    test_df = con.read_csv("/media/bhushan/nvme1/data/vldb/b20/s4_test.csv")
...
if __name__=='__main__':
    ...
    writer.writerow(["b20", "4.2GB", "s4.csv","polars",time2,format(ram_usage),"204B"])
    file.close()
