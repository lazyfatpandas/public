...
def myfunc():
    ...
    import os
    print = pd.lazyPrint
    train_df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b20/s4_train.csv')
    ...
    train_df['word_count'] = train_df.full_text.apply(lambda x: len(x.split()), meta=('full_text', 'int64'))    # Mean word count:
    # LAFP: print added
...
if __name__=='__main__':
    ...
    writer.writerow(["b20", "4.2GB", "s4.csv","ldask",time2,format(ram_usage),2046])
    file.close()
