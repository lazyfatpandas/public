...
def myfunc():
    ...
    df_riders_data_to_load = pd.read_csv('/media/bhushan/nvme1/data/vldb/b33/s3_ride.csv',dtype=SO_c_d_t)
...
if (__name__ == '__main__'):
    ...
    writer.writerow(['b33','1.4GB','s3.csv','lspark',time2,format(ram_usage),3338])
    file.close()
pd.flush()
