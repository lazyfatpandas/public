...
def myfunc():
  ...
  ratings_df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b2/s2.csv',low_memory=False,dtype=SO_c_d_t)
...
if (__name__ == '__main__'):
   ...
   writer.writerow(['b8','450MB','s2.csv','lpolars',time2,format(ram_usage),'82C'])
   file.close()
pd.flush()
