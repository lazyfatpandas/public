...
def myfunc():
    start = time()
    print=pd.lazyPrint
    df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b21/s5_city.csv', dtype={'NUMBER': 'object', 'UNIT': 'object'})  # NOTE: dtype
    print(df.head())
...
if __name__=='__main__':
    ...
    writer.writerow(["b21", "12.6GB", "s5.csv","ldask",time2,format(ram_usage),2156])
    file.close()
