...
def myfunc():
    start = time()
    print=pd.lazyPrint
    df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b1/s2.csv',  parse_dates=['tpep_pickup_datetime']) # fetch data
...
if __name__=='__main__':
    ...
    writer.writerow(["b31", "450MB", "s2.csv","lpandas",time2,format(ram_usage),122])
    file.close()
