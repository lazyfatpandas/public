...
def myfunc():
  ...
  df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b1/s2.csv',parse_dates=['tpep_pickup_datetime'],usecols=SO_columns)
...
if (__name__ == '__main__'):
   ...
   writer.writerow(['b1','450MB','s2.csv','ldask',time2,format(ram_usage),126])
   file.close()
