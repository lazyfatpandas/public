...
def myfunc():
    ...
    df_riders_data_to_load = pd.read_csv('/media/bhushan/nvme1/data/vldb/b33/s5_ride.csv')
    ...
    # create scatter plot
    plt.scatter(x_urban.compute(), y_urban.compute(), label="Urban", s=s_urban.compute() * 10, color=["pink"], edgecolor="black", alpha=1, marker="o")
    plt.scatter(x_rural.compute(), y_rural.compute(), label="Rural", s=s_rural.compute() * 10, color=["purple"], edgecolor="black", alpha=1, marker="o")
    plt.scatter(x_suburban.compute(), y_suburban.compute(), label="Suburban", s=s_suburban.compute() * 10, color=["orange"], edgecolor="black", alpha=1, marker="o")
    plt.grid()
    ...
    plt.pie(fare_sum.compute(), explode=explode, labels=labels, colors=colors, autopct="%1.1f%%", shadow=True, startangle=150)
    ...
    explode = (0.1, 0.1, 0.1)
    colors = ["lightblue", "lightgreen", "lightcoral"]
    plt.pie(rides_count.compute(), explode=explode, labels=labels, colors=colors, autopct="%1.1f%%", shadow=True, startangle=150)
    ...
    explode = (0.1, 0.1, 0.1)
    colors = ["lightblue", "lightgreen", "lightcoral"]
    plt.pie(drivers_sum.compute(), explode=explode, labels=labels, colors=colors, autopct="%1.1f%%", shadow=True, startangle=150)
...
if __name__=='__main__':
    ...
    writer.writerow(["b33", "12.6GB", "s5.csv","dask",time2,format(ram_usage),3315])
    file.close()
