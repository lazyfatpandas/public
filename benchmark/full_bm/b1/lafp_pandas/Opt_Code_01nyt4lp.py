...
def myfunc():
    ...
    df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b1/s4.csv',usecols=SO_columns,parse_dates=SO_d_d_t)
...
if (__name__ == '__main__'):
   ...
   writer.writerow(['b1','4.2GB','s4.csv','lpandas',time2,format(ram_usage),142])
   file.close()
