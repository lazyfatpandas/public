...
def myfunc():
  ...
  train_df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b20/s1_train.csv',usecols=SO_columns)
  ...
  train_df['word_count'] = train_df.full_text.apply(lambda x: len(x.split()))# pANDAS lINE
...
if (__name__ == '__main__'):
   ...
   writer.writerow(['b20','150MB','s1.csv','ldask',time2,format(ram_usage),2016])
   file.close()
