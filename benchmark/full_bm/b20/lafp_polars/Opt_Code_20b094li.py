...
def myfunc():
  print = pd.lazyPrint
  start = time()
  SO_columns = ["cohesion","syntax","vocabulary","phraseology","grammar","conventions"]
  train_df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b20/s4_train.csv',usecols=SO_columns)
...
if (__name__ == '__main__'):
   ...
   writer.writerow(['b20','4.2GB','s4.csv','lpolars',time2,format(ram_usage),'204C'])
   file.close()
pd.flush()
