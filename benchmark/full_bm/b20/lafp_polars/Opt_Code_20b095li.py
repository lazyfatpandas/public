...
def myfunc():
  ...
  train_df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b20/s5_train.csv',usecols=SO_columns)
...
if (__name__ == '__main__'):
   ...
   writer.writerow(['b20','12.6GB','s5.csv','lpolars',time2,format(ram_usage),'205C'])
   file.close()
pd.flush()
