...
def myfunc():
    ...
    train_df = con.read_csv("/media/bhushan/nvme1/data/vldb/b20/s1_train.csv")
    print(train_df.schema())
    test_df = con.read_csv("/media/bhushan/nvme1/data/vldb/b20/s1_test.csv")
...
if __name__=='__main__':
    ...
    writer.writerow(["b20", "150MB", "s1.csv","ibis",time2,format(ram_usage),2019])
    file.close()
