...
def myfunc():
    start = time()
    import numpy as np
    df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b16/s4.csv',delimiter=';')
    print(df.head())
    print(df.describe())
...
if __name__=='__main__':
    ...
    writer.writerow(["b16", "4.2GB", "s4.csv","dask",time2,format(ram_usage),1645])
    file.close()
