...
def myfunc():
    ...
    df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b3/s3.csv',usecols=SO_columns,dtype=SO_c_d_t)
...
if (__name__ == '__main__'):
   ...
   writer.writerow(['b6','1.4GB','s3.csv','lpandas',time2,format(ram_usage),632])
   file.close()
