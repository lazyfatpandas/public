...
def myfunc():
    ...
    df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b3/s2.csv',usecols=SO_columns,dtype=SO_c_d_t)
...
if (__name__ == '__main__'):
   ...
   writer.writerow(['b6','450MB','s2.csv','lpandas',time2,format(ram_usage),622])
   file.close()
