...
def myfunc():
    ...
    df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b12/s3.csv',usecols=SO_columns,dtype=SO_c_d_t)
    print(df.head())
...
if (__name__ == '__main__'):
   ...
   writer.writerow(['b12','1.4GB','s3.csv','lpandas',time2,format(ram_usage),1232])
   file.close()
