...
def myfunc():
    ...
    df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b12/s4.csv',usecols=SO_columns,dtype=SO_c_d_t)
    print(df.head())
...
if (__name__ == '__main__'):
   ...
   writer.writerow(['b12','4.2GB','s4.csv','lpandas',time2,format(ram_usage),1242])
   file.close()
