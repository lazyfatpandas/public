...
import eqsql.dbridge.analysis.eqsql.expr.operator.OrOp;
import eqsql.exceptions.QueryTranslationException;

/**
 * Created by ek on 17/10/16.
 */
public class OrNode extends Node implements HQLTranslatable, SQLTranslatable {
    public OrNode(Node cond1, Node cond2) {
        super(new OrOp(), cond1, cond2);
    }
