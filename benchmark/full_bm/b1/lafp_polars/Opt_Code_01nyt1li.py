...
def myfunc():
  ...
  df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b1/s1.csv',usecols=SO_columns,dtype=SO_c_d_t,parse_dates=SO_d_d_t)
...
if (__name__ == '__main__'):
   ...
   writer.writerow(['b1','150MB','s1.csv','lpolars',time2,format(ram_usage),'11C'])
   file.close()
pd.flush()
