...
def myfunc():
  ...
  df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b21/s1_city.csv',dtype=SO_c_d_t)
  print(df.head())
  ...
  print(df)
  SO_c_d_t = {"zipcode":"category","address":"str"}
  df2 = pd.read_csv('/media/bhushan/nvme1/data/vldb/b21/s1_pluto.csv',dtype=SO_c_d_t)
  print(df2.head(1))
...
if (__name__ == '__main__'):
   ...
   writer.writerow(['b21','150MB','s1.csv','ldask',time2,format(ram_usage),2116])
   file.close()
