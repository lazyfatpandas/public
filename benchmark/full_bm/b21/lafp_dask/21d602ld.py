...
def myfunc():
    start = time()
    print=pd.lazyPrint
    df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b21/s2_city.csv', dtype={'NUMBER': 'object', 'UNIT': 'object'})  # NOTE: dtype
    print(df.head())
...
if __name__=='__main__':
    ...
    writer.writerow(["b1", "450MB", "s2.csv","ldask",time2,format(ram_usage),2126])
    file.close()
