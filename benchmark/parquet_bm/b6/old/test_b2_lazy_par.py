...
# df = pd.read_parquet('/media/bhushan/nvme1/data/vldb/b3/s4.parquet',columns=SO_columns)
df = pd.read_parquet('/home/bhushan/nvme1/data/vldb/b3/s1.parquet',columns=SO_columns)
