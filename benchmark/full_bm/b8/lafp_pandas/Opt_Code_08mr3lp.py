...
def myfunc():
  ...
  ratings_df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b2/s3.csv',low_memory=False,dtype=SO_c_d_t)
...
if (__name__ == '__main__'):
   ...
   writer.writerow(['b8','1.4GB','s3.csv','lpandas',time2,format(ram_usage),832])
   file.close()
