...
def myfunc():
    ...
    train_df = con.read_csv("/media/bhushan/nvme1/data/vldb/b20/s5_train.csv")
    print(train_df.schema())
    test_df = con.read_csv("/media/bhushan/nvme1/data/vldb/b20/s5_test.csv")
...
if __name__=='__main__':
    ...
    writer.writerow(["b20", "12.6GB", "s5.csv","polars",time2,format(ram_usage),"205B"])
    file.close()
