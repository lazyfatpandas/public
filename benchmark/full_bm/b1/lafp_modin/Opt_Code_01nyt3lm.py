...
def myfunc():
  ...
  df = pd.read_csv('/media/bhushan/nvme1/data/vldb/b1/s3.csv',parse_dates=['tpep_pickup_datetime'],usecols=SO_columns)
...
if (__name__ == '__main__'):
   ...
   writer.writerow(['b1','1.4GB','s3.csv','lmodin',time2,format(ram_usage),134])
   file.close()
